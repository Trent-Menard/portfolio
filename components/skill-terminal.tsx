  ...
  return (
    <div className="space-y-6">
      {categories.map((category) => (
        <Card key={category} className="p-6 bg-card/50 backdrop-blur-sm border-border/50">
          <h3 className="text-lg font-mono font-semibold mb-4 text-primary">./{category.toLowerCase()}/</h3>
