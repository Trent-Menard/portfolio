...
const skills: Skill[] = [
  ...
  { name: "TypeScript/JavaScript", level: 80, category: "Frontend", logo: ["typescript.svg", "javascript.svg"] },
  { name: "HTML/CSS", level: 80, category: "Frontend", logo: ["html.svg", "css.svg"] },
  ...
  { name: "MySQL", level: 75, category: "Database", logo: "mysql.svg"},
